...
+ function($) {
  ...
  $.toast = function(text, style, callback) {
    ...
    show('<i class="' + iconClassName + ' weui-icon_toast"></i><p class="weui-toast_content">' + (text || "Было завершено") + '</p>', className);
  ...
  $.showLoading = function(text) {
    ...
    html += '</div>';
    html += '<p class="weui-toast_content">' + (text || "загрузка") + '</p>';
