...
<head>
  ...
  <link rel="preload" href="<?php echo asset("assets/css/theme.min.css") ?>" data-hs-appearance="default" as="style">
  <link rel="preload" href="<?php echo asset("assets/css/theme-dark.min.css") ?>" data-hs-appearance="dark" as="style">
          ...
          <div class="card-body">
            ...
            <form class="js-validate needs-validation" novalidate>
              ...
              <div class="mb-4">
                ...
                <input type="text" class="form-control form-control-lg" name="login" id="login" tabindex="1"
                  placeholder="login" aria-label="login" required>
              ...
              <div class="mb-4">
                ...
                <div class="input-group input-group-merge" data-hs-validation-validate-class>
                  <input type="password" class="js-toggle-password form-control form-control-lg" name="password"
                    id="password" placeholder="8+ characters required" aria-label="8+ characters required" required
                    minlength="2" data-hs-toggle-password-options='{
      ...
      window.onload = function () {
        ...
        HSBsValidation.init('.js-validate', {
          onSubmit: data => {
            ...
            $.ajax({
              url: '<?php echo route("admin.api.login")?>',
              method: 'POST',
              data: {
                username: data.form[1].value,
                password: data.form[2].value,
