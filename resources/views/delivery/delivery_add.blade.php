		...
		<form method="post" id="form">
			...
			<div class="zc_box2">
				<div class="zc_list">
					...
					<div class="zc_text"><input type="text" name="user_tname" placeholder="ПІБ"></div>
				</div>
				<div class="zc_list">
					<div class="zc_name">Номер телефону</div>
					<div class="zc_text"><input type="text" name="user_phone" placeholder="Номер телефону"></div>
				</div>
				<!-- 		<div class="zc_list">
			<div class="zc_name">місцезнаходження</div>
			<div class="zc_text">
				<input type="text" name="shengshi" value="  " placeholder="Будь ласка, виберіть місто" id="shengshi" />
			...
			<i class="jt_r"></i>
				...
				<div class="zc_list zc_textarea">
					...
					<div class="zc_text"><textarea type="text" name="address_text" placeholder="Повна адреса"></textarea></div>
				</div>
				<div class="sh_moren">
					<label for="default">
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#shengshi").cityPicker({
				...
				onChange: function(picker, values, displayValues) { //вибір після події
