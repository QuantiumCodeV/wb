...
<head>
	...
	<title>Список рахунків для інкасації - Rozetka</title>
...
<body>
	<div class="pagetop">
		...
		<div>Список рахунків для інкасації</div>
...
<div class="top_menu" id="top_menu">
	...
	<div class="content" style="margin-bottom:75px;">
		...
		@foreach($methods as $method)
			<div class="user_box_zh mat10 pageid" style="border-bottom:0;">
				<div class="add_list">
					<span class="fl">{{ $method->bank }} ({{ $method->card }})</span>
					<span class="fr">{{ $method->name }}</span>
					<div class="clear"></div>
					<div class="xian"></div>
					<div class="fr mat10">
						<a href="{{ route('api.payment.delete', ['method' => $method->id]) }}" 
									onclick="return app_delinfo(this, 'Ви впевнені, що видалите цей акаунт?')" 
	...
	<div class="fb_btn1"><a href="<?php echo route("payment.add") ?>">новий акаунт</a></div>
