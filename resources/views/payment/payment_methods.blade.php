...
<head>
	...
	<title>Список счетов для инкассо - Wildberries</title>
...
<body>
	<div class="pagetop">
		...
		<div>Список счетов для инкассо</div>
...
<div class="top_menu" id="top_menu">
				...
				<div class="add_list">
					...
					<div class="fr mat10">
						<a href="{{ route('api.payment.delete', ['method' => $method->id]) }}" 
									onclick="return app_delinfo(this, 'Вы уверены, что удалите этот аккаунт?')" 
	...
	<div class="fb_btn1"><a href="<?php echo route("payment.add") ?>">новый аккаунт</a></div>
