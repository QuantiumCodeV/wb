...
<body>
  ...
  <div class="top_box1">
    <div class="pagetop1">
      <div class="top_logo">
        <a href="<?php  echo route("index") ?>"><img src="<?php echo asset("assets/345645615.svg")?>" /></a>
      </div>
  ...
  <div class="content" style="margin: 55px 0 60px">
    ...
    <div class="tuijian_list mat10">
      ...
      <a href="{{ route('product', $product->id) }}" title="{{ $product->name }}">
        ...
        <img src="{{ !empty($product->images) && !empty($product->images[0]) ? asset('storage/' . $product->images[0]) : asset('assets/default.png') }}" data-url="" title="{{ $product->name }}"
        class="js_imgload" />
        </div>
      </a>
