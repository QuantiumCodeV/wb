...
<head>
  ...
  color:#666;
        ...
        .fh1 a {
            background: url(../images/icon_index.png) no-repeat scroll -188px -95px / 200px 200px;
            display: block;
            width: 20px;
            height: 22px;
        }
        ...
        .cd1 a {
            background: url(../images/icon_index.png) no-repeat scroll -123px -95px / 200px 200px;
            display: block;
            width: 20px;
            height: 22px;
        }
        ...
        .cd2 a {
            background: url(../images/icon_index.png) no-repeat scroll -68px -61px / 200px 200px;
            display: block;
            width: 20px;
            height: 22px;
        }
        ...
        .fh a {
            background: url(../images/icon_index.png) no-repeat scroll -105px -28px / 200px 200px;
            display: block;
            width: 20px;
            height: 22px;
        }
        ...
        .cd a {
            background: url(../images/icon_index.png) no-repeat scroll -153px -95px / 200px 200px;
            display: block;
            width: 25px;
            height: 25px;
        }
        ...
        .shuliang .img2 i {
            background: url(../images/ico_jia.png) no-repeat 5px 5px;
            background-size: 20px auto;
            width: 20px;
            height: 20px;
            display: block;
        ...
        .shuliang .img1 i {
            background: url(../images/ico_jian.png) no-repeat 5px 5px;
            background-size: 20px auto;
            width: 20px;
            height: 20px;
            display: block;
        ...
        .join i {
            background: url(../images/foot_nav.png) no-repeat scroll -75px -56px / 200px 200px;
            display: block;
            width: 25px;
            height: 23px;
            text-align: center;
        ...
        .qq i {
            background: url(../images/foot_nav.png) no-repeat scroll -36px -55px / 200px 200px;
            display: block;
            width: 23px;
            height: 23px;
            text-align: center;
        ...
        .js_radio .dui {
            background: url(../images/dui_2.png) no-repeat;
            background-size: 20px auto;
            width: 20px;
            height: 20px;
            display: block;
        ...
        .js_radio.sel .dui {
            background: url(../images/dui_1.png) no-repeat;
            background-size: 20px auto;
            width: 20px;
            height: 20px;
            display: block;
        ...
        .user_list li span {
            background: url(../images/dd_icon.png) no-repeat scroll 0 0 / 200px 200px rgba(0, 0, 0, 0);
...
.foot_nav i.foot_i5{background-position:-160px -2px;}*/
        ...
        .foot_sc a {
            background: url(../images/foot_nav.png) no-repeat scroll -74px -76px / 200px 200px;
            display: block;
            width: 35px;
            height: 35px;
            margin: 0 auto;
        ...
        .foot_fx a {
            background: url(../images/foot_nav.png) no-repeat scroll -110px -76px / 200px 200px;
            display: block;
            width: 35px;
            height: 35px;
            margin: 0 auto;
        ...
        .foot_jt a {
            background: url(../images/foot_nav.png) no-repeat scroll -145px -78px / 200px 200px;
            display: block;
            width: 35px;
            height: 35px;
            margin: 0 auto;
        ...
        .kf_ico1 i {
            background: url(../images/foot_nav.png) no-repeat scroll 0 -84px / 200px 200px;
            display: inline-block;
            width: 23px;
            height: 23px;
            margin: 3px 3px 0 0
        ...
        .kf_ico2 i {
            background: url(../images/foot_nav.png) no-repeat scroll -27px -84px / 200px 200px;
            display: inline-block;
            width: 23px;
            height: 23px;
        ...
        .kf_ico3 i {
            background: url(../images/foot_nav.png) no-repeat scroll -53px -84px / 200px 200px;
            display: inline-block;
            width: 23px;
            height: 23px;
            margin: 3px 3px 0 2px
...
<body>
    ...
    <div class="pagetop" style="position:fixed; top:0; left:0; width:100%; z-index:999; display:none;">
        <div class="fh">
            <a href="javascript:app_open('back');"></a>
        </div>
        <div></div>
        <div class="cd">
	...
	<div class="pro_tt" id="js_menu">
		<a href="javascript:;" class="sel">деталь<span class="xian1"></span></a>
		<a href="javascript:;"><span style="position:relative">评价<span class="plnum">0</span></span></a>
		<div class="clear"></div>
	</div>
</div>-->
        <!--详情 Start-->
        ...
        <div class="promain js_menuhtml" style="display:none;">
            ...
            <div class="ask_form">我要咨询 <div class="mat10 mar10">
                ...
                <div class="loginbtn"><input type="button" value="OK" class="ask_btn" onclick="ask_add()"></div>
            </div>
        </div>
    </div>
    <!--咨询 End-->
    ...
    <script>
        function Furl() {
            window.location.href = "https://m.vip.com/product-1710617004-6919198040246203724.html?wq=1"
    ...
    <div id="page_buy" class="divhide"
        style="position: fixed; width: 100%; height: 244px; z-index: 100; bottom: 0px; left: 0px; background-color: rgb(255, 255, 255); display: none; overflow-y: auto;">
            ...
            <div class="sh_box">
                ...
                <div class="sh_buy">
                    ...
                    <div class="shuliang">
                        ...
                        <span class="img2" onclick="pe_numchange('product_num', '+', 326);"><i></i></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="page_share" class="divhide">
        <div class="add_tt">Поделиться</div>
        <div class="close_btn" onclick="app_page_close();"></div>
        <div style="position:relative">
            <div class="share_box" id="share_html">
                <div class="share_img"><img src="{{ !empty($product->images) && !empty($product->images[0]) ? asset('storage/' . $product->images[0]) : asset('assets/default.png') }}">
                </div>
                <div class="share_pro">
    ...
    <script type="text/javascript">
        window.onload = function() {
            ...
            // 	$('#ccc').attr('style','display:none;')
            $('#bbb').attr('style', 'width:100%')
            // 	$('#fff').attr('style','display:none;')
            // console.log(window.location.href)
            var url = window.location.href;
            if (url.split("/dd/")[1] === '1') {
                //拼单
                $('#aaa').attr('style', 'width:100%')
                $('#ccc').attr('style', 'display:none;')
                $('#bbb').attr('style', 'display:none;')
                $('#eee').attr('style', 'display:none;')
            } else if (url.split("/dd/")[1] === '2') {
        ...
        function kefu_btn() {
            $.actions({
                actions: [{
                    text: '<a class="kf_ico1" href=""><i></i>Поддержка</a>'
                }, {
                    text: '<a class="kf_ico2" href="tel:"><i></i></a>'
                }]
            });
        }
        //购买/В корзину按钮
        function buy_btn(act, id) {
            if ('1' == false) {
                app_open("<?php echo route("auth.login") ?>");
                return;
            }
